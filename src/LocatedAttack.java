...
public class LocatedAttack extends Attack{  // la classe LocatedAttack ( L'attaque de mélée) est une classe fille de la classe Attack qui englobe toute les attaques
  ...
  // Méthode d'attaque ciblée sur une case séléctionée adjacente à celle de l'attaquant. Renvoie un booléen true si l'attaque a eu lieu, false si l'attaque n'a pas eu lieu  
